...
const CTAMap = dynamic(() => import("./cta-map"), { ssr: false })
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, textAlign: "left" }}>
          ...
          <h2
            className="cta-headline fade-up delay-1"
            style={{
          ...
          <div className="fade-up delay-3" style={{ textAlign: "left" }}>
            <a
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8, textAlign: "left" }}>
              <span style={{ fontFamily: "var(--font-sans)", fontSize: 14, color: "rgba(255,255,255,0.75)" }}>
