...
export function Hero() {
  ...
  // Esse feitiço garante que a animação só roda no navegador do usuário,
  // impedindo o robô da Vercel de crashar no servidor!
  useEffect(() => {
    setMounted(true)
  }, [])
  ...
  return (
    <section style={{ 
      ...
      {/* A SUA ANIMAÇÃO BONITA (Só carrega se estiver montado no navegador) */}
